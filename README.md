...
- Una instancia del backend corriendo: [Assignment Manager API](https://github.com/Z3E-Brian/Assignment_Manager)
...
```bash
git clone https://github.com/Z3E-Brian/Assignment_Manager_Client.git
